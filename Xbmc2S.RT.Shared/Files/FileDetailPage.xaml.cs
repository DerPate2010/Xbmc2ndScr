...
namespace Xbmc2S.RT
{
    ...
    public sealed partial class FileDetailPage : Page
    {
        ...
        private void AdaptWindowSize()
        {
            ...
            {
                ContentPanel.Margin = new Thickness(39, 0, 39, 39);
            }
            else
            {
                ContentPanel.Margin= new Thickness(117, 0, 117, 49);
            }
        }
        ...
        private async void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            var file = await App.MainVm.GetFileDetails(path, Media.video);

            DefaultViewModel["FileInfo"] = file;
