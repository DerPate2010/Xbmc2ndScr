...
namespace XBMCRPC
{
    ...
    {
		public Client(IPlatformServices platformServices, string host, int port=8080, string userName="xbmc", string password=""):this(new ConnectionSettings(host,port,userName,password), platformServices)
        {
        }
