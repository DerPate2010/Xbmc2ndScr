...
namespace XBMCRPC
{
    ...
    public partial class Client
    {
		...
		public Client(IPlattformServices plattformServices, string host, int port=8080, string userName="xbmc", string password=""):this(new ConnectionSettings(host,port,userName,password), plattformServices)
        {
        }
