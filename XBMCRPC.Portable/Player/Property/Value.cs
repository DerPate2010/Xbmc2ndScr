namespace XBMCRPC.Player.Property
{
   public class Value
   {
       public XBMCRPC.Player.Audio.Stream[] audiostreams {get;set;}
       ...
       public XBMCRPC.Player.Audio.Stream.Extended currentaudiostream {get;set;}
       ...
       public XBMCRPC.Player.Subtitle[] subtitles {get;set;}
